<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-custom.label for="name" value="Token Name" />
                <x-custom.input id="name" type="text" class="mt-1 block w-full" wire:model.defer="createApiTokenForm.name" autofocus />
            ...
            @if (Laravel\Jetstream\Jetstream::hasPermissions())
                <div class="col-span-6">
                    <x-custom.label for="permissions" value="Permissions" />
    ...
    <x-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="$set('displayingToken', false)" wire:loading.attr="disabled">
                {{ __('Close') }}
    ...
    <x-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="$set('managingApiTokenPermissions', false)" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-custom.secondary-button>

            <x-custom.button class="ml-2" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-custom.button>
        </x-slot>
    </x-dialog-modal>
    ...
    <x-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="$toggle('confirmingApiTokenDeletion')" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-custom.secondary-button>
