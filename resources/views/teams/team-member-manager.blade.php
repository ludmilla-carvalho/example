<div>
            ...
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-custom.input id="name" type="text" class="block w-full mt-1" wire:model.defer="addTeamMemberForm.email" />
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-custom.label for="role" value="{{ __('Role') }}" />
                            <x-custom.input-error for="role" class="mt-2" />
    ...
    <x-dialog-modal wire:model="currentlyManagingRole">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="stopManagingRole" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-custom.secondary-button>

            <x-custom.button class="ml-2" wire:click="updateRole" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-custom.button>
        </x-slot>
    </x-dialog-modal>
    ...
    <x-confirmation-modal wire:model="confirmingLeavingTeam">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="$toggle('confirmingLeavingTeam')" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-custom.secondary-button>
    ...
    <x-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        ...
        <x-slot name="footer">
            <x-custom.secondary-button wire:click="$toggle('confirmingTeamMemberRemoval')" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-custom.secondary-button>
